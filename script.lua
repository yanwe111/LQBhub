...
local keycheck = "Fasd"
local key1 = key
if key1 == "YuG6o28gxJHhurlwIHRyYWk=" then
	keycheck = true
else
	keycheck = false
end
...
LQBHub_2.Position = UDim2.new(-0.421820998, 0, -0.00107681751, 0)
...
ImageLabel.Position = UDim2.new(0.215904146, 0, 0.072854057, 0)
ImageLabel.Size = UDim2.new(0, 36, 0, 31)
ImageLabel.Image = "rbxassetid://6247725804"

-- Scripts:

local function PJJXTUJ_fake_script() -- open.open mainpage 
...
coroutine.wrap(PJJXTUJ_fake_script)()
local function TGIXF_fake_script() -- minimize.hide mainpage 
...
coroutine.wrap(TGIXF_fake_script)()
local function SXVM_fake_script() -- waypoint.LocalScript 
...
coroutine.wrap(SXVM_fake_script)()
local function HGTVYBI_fake_script() -- autofarm.LocalScript 
...
coroutine.wrap(HGTVYBI_fake_script)()
local function WCWYC_fake_script() -- extras.LocalScript 
...
coroutine.wrap(WCWYC_fake_script)()
local function YQERVX_fake_script() -- autodig.LocalScript 
...
coroutine.wrap(YQERVX_fake_script)()
local function UXGBW_fake_script() -- equipdemon.LocalScript 
...
coroutine.wrap(UXGBW_fake_script)()
local function ZMVTYCQ_fake_script() -- equipgummy.LocalScript 
...
coroutine.wrap(ZMVTYCQ_fake_script)()
local function LECOHWW_fake_script() -- equipdiamond.LocalScript 
...
coroutine.wrap(LECOHWW_fake_script)()
local function GURYF_fake_script() -- KillTunel.LocalScript 
...
coroutine.wrap(GURYF_fake_script)()
local function BMNYVOF_fake_script() -- KillCoconut.LocalScript 
...
coroutine.wrap(BMNYVOF_fake_script)()
local function QTSABZ_fake_script() -- KillKing.LocalScript 
...
coroutine.wrap(QTSABZ_fake_script)()
local function UHOYYE_fake_script() -- Noclip.LocalScript 
...
coroutine.wrap(UHOYYE_fake_script)()
local function UEGO_fake_script() -- KillSnail.LocalScript 
...
coroutine.wrap(UEGO_fake_script)()
local function ORDH_fake_script() -- AutoDispenser.LocalScript 
...
coroutine.wrap(ORDH_fake_script)()
local function DVQKQVI_fake_script() -- settings.LocalScript 
...
coroutine.wrap(DVQKQVI_fake_script)()
local function WHHSD_fake_script() -- Bamboo.LocalScript 
...
coroutine.wrap(WHHSD_fake_script)()
local function TUJQV_fake_script() -- Dandelion.LocalScript 
...
coroutine.wrap(TUJQV_fake_script)()
local function KGVLHY_fake_script() -- Mushroom.LocalScript 
...
coroutine.wrap(KGVLHY_fake_script)()
local function XZXOOG_fake_script() -- Blueflower.LocalScript 
...
coroutine.wrap(XZXOOG_fake_script)()
local function TLFC_fake_script() -- Sunflower.LocalScript 
...
coroutine.wrap(TLFC_fake_script)()
local function RUHE_fake_script() -- Spider.LocalScript 
...
coroutine.wrap(RUHE_fake_script)()
local function BNJKO_fake_script() -- Clover.LocalScript 
...
coroutine.wrap(BNJKO_fake_script)()
local function HNOQUBG_fake_script() -- Cactus.LocalScript 
...
coroutine.wrap(HNOQUBG_fake_script)()
local function FUOCHH_fake_script() -- Pineapple.LocalScript 
...
coroutine.wrap(FUOCHH_fake_script)()
local function TCLS_fake_script() -- Stump.LocalScript 
...
coroutine.wrap(TCLS_fake_script)()
local function GIHY_fake_script() -- Strawberry.LocalScript 
...
local function JIUPF_fake_script() -- Pinetree.LocalScript 
...
coroutine.wrap(JIUPF_fake_script)()
local function CMFO_fake_script() -- Rose.LocalScript 
...
coroutine.wrap(CMFO_fake_script)()
local function KEJJWVS_fake_script() -- Pumpkin.LocalScript 
...
coroutine.wrap(KEJJWVS_fake_script)()
local function BSCUVSM_fake_script() -- Mountain.LocalScript 
...
coroutine.wrap(BSCUVSM_fake_script)()
local function LERATQF_fake_script() -- Coconut.LocalScript 
...
coroutine.wrap(LERATQF_fake_script)()
local function XVVBPIA_fake_script() -- Pepper.LocalScript 
...
coroutine.wrap(XVVBPIA_fake_script)()
local function NTFV_fake_script() -- Autofarmtween.LocalScript 
...
coroutine.wrap(NTFV_fake_script)()
local function NXDMAM_fake_script() -- Typeautofarm.LocalScript 
...
coroutine.wrap(NXDMAM_fake_script)()
local function QWUTY_fake_script() -- Tween.LocalScript 
...
coroutine.wrap(QWUTY_fake_script)()
local function WUOF_fake_script() -- Walking.LocalScript 
...
coroutine.wrap(WUOF_fake_script)()
local function ZQBK_fake_script() -- Autofarmwalk.LocalScript 
...
coroutine.wrap(ZQBK_fake_script)()
local function OPBEW_fake_script() -- Dandelion_2.LocalScript 
...
coroutine.wrap(OPBEW_fake_script)()
local function ZFBW_fake_script() -- Mushroom_2.LocalScript 
...
coroutine.wrap(ZFBW_fake_script)()
local function KIPT_fake_script() -- Clover_2.LocalScript 
...
coroutine.wrap(KIPT_fake_script)()
local function SVPM_fake_script() -- Sunflower_2.LocalScript 
...
coroutine.wrap(SVPM_fake_script)()
local function QXZZW_fake_script() -- Spider_2.LocalScript 
...
coroutine.wrap(QXZZW_fake_script)()
local function STWBA_fake_script() -- Blueflower_2.LocalScript 
...
coroutine.wrap(STWBA_fake_script)()
local function IRUHU_fake_script() -- Bamboo_2.LocalScript 
...
coroutine.wrap(IRUHU_fake_script)()
local function OXWMBJ_fake_script() -- Pinetree_2.LocalScript 
...
coroutine.wrap(OXWMBJ_fake_script)()
local function AJHDFL_fake_script() -- Strawberry_2.LocalScript 
...
coroutine.wrap(AJHDFL_fake_script)()
local function DUXUSA_fake_script() -- Cactus_2.LocalScript 
...
coroutine.wrap(DUXUSA_fake_script)()
local function PBPZO_fake_script() -- Rose_2.LocalScript 
...
coroutine.wrap(PBPZO_fake_script)()
local function ASIEW_fake_script() -- Pumpkin_2.LocalScript 
...
coroutine.wrap(ASIEW_fake_script)()
local function XUHOMI_fake_script() -- Pepper_2.LocalScript 
...
coroutine.wrap(XUHOMI_fake_script)()
local function TUZYEFM_fake_script() -- Coconut_2.LocalScript 
...
coroutine.wrap(TUZYEFM_fake_script)()
local function LQZZ_fake_script() -- Pineapple_2.LocalScript 
...
coroutine.wrap(LQZZ_fake_script)()
local function JSEIW_fake_script() -- Stump_2.LocalScript 
...
coroutine.wrap(JSEIW_fake_script)()
local function BPNANOI_fake_script() -- Mountain_2.LocalScript 
...
coroutine.wrap(BPNANOI_fake_script)()
local function VIWRAS_fake_script() -- BeginnerShop.LocalScript 
...
coroutine.wrap(VIWRAS_fake_script)()
local function CZYG_fake_script() -- ProShop.LocalScript 
...
coroutine.wrap(CZYG_fake_script)()
local function LTGMUUU_fake_script() -- TopShop.LocalScript 
...
coroutine.wrap(LTGMUUU_fake_script)()
local function DNQRXQP_fake_script() -- MegaMemory.LocalScript 
...
coroutine.wrap(DNQRXQP_fake_script)()
local function SOPZHNT_fake_script() -- Memory.LocalScript 
...
coroutine.wrap(SOPZHNT_fake_script)()
local function UKJZTNC_fake_script() -- Night.LocalScript 
...
coroutine.wrap(UKJZTNC_fake_script)()
local function RZXKNW_fake_script() -- ExtremeMemory.LocalScript 
...
coroutine.wrap(RZXKNW_fake_script)()
local function UTRTGXR_fake_script() -- GummyMask.LocalScript 
...
coroutine.wrap(UTRTGXR_fake_script)()
local function RNJUKJO_fake_script() -- DiamondMask.LocalScript 
...
coroutine.wrap(RNJUKJO_fake_script)()
local function GQVYMLL_fake_script() -- DemonMask.LocalScript 
...
coroutine.wrap(GQVYMLL_fake_script)()
local function FNZDITG_fake_script() -- Onett.LocalScript 
...
coroutine.wrap(FNZDITG_fake_script)()
local function HSHK_fake_script() -- BlackBear.LocalScript 
...
coroutine.wrap(HSHK_fake_script)()
local function LLBV_fake_script() -- BrownBear.LocalScript 
...
coroutine.wrap(LLBV_fake_script)()
local function YQAWY_fake_script() -- KingBettle.LocalScript 
...
coroutine.wrap(YQAWY_fake_script)()
local function ADKFN_fake_script() -- SpiritBear.LocalScript 
...
coroutine.wrap(ADKFN_fake_script)()
local function MIJRED_fake_script() -- ScienceBear.LocalScript 
...
coroutine.wrap(MIJRED_fake_script)()
local function QVKX_fake_script() -- PolarBear.LocalScript 
...
coroutine.wrap(QVKX_fake_script)()
local function CTBB_fake_script() -- PandaBear.LocalScript 
...
coroutine.wrap(CTBB_fake_script)()
local function EJFSXY_fake_script() -- MotherBear.LocalScript 
...
coroutine.wrap(EJFSXY_fake_script)()
local function CKFKCSB_fake_script() -- Stick.LocalScript 
...
coroutine.wrap(CKFKCSB_fake_script)()
local function JSGPMA_fake_script() -- Wind.LocalScript 
...
coroutine.wrap(JSGPMA_fake_script)()
local function IPFBSR_fake_script() -- Petal.LocalScript 
...
coroutine.wrap(IPFBSR_fake_script)()
local function XPSGBY_fake_script() -- TunelBear.LocalScript 
...
coroutine.wrap(XPSGBY_fake_script)()
local function EZPO_fake_script() -- HoneyBee.LocalScript 
...
coroutine.wrap(EZPO_fake_script)()
local function ECDNKMN_fake_script() -- TextLabel.LocalScript 
...
coroutine.wrap(ECDNKMN_fake_script)()
local function WKKUPFV_fake_script() -- LQBHub_2.LocalScript 
...
coroutine.wrap(WKKUPFV_fake_script)()
